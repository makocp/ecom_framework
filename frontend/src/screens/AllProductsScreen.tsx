...
import {IShopifyProduct, useShopifyData} from "../providers/ProductData/ShopifyProvider";

const AllProductsScreen = () => {
    const [searchQuery, setSearchQuery] = useState<string>('');
    const [filteredProducts, setFilteredProducts] = useState<IShopifyProduct[]>([]);
    ...
    return (
        <FadeInScreen>
            <View style={[styles.container, {paddingTop: insets.top}]}>
                <AppBar screenName={'All Products'} />
                <SearchBar
                    ref={searchBarRef}
